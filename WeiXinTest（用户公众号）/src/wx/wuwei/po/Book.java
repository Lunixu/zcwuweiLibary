...
public class Book {
	...
	public ArrayList Search(String s,String libaryId)
	{   
		...
		{    
			...
			rs.beforeFirst();
			 ...
			 if(length==0)
			 {
				 sql+="select * from book where libaryId="+libaryId+" and "+rs.getString("name")+" like '%"+s+"%' ";
			 }
			 else
			 {
				 sql+="select * from book where libaryId="+libaryId+" and "+rs.getString("name")+" like '%"+s+"%' UNION ";
			 }
			 }
